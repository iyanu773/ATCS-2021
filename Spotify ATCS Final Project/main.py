...
def main():
    ...
    if(userCmd == 'song'):
        ...
        if(userCmd == 'list'):
            ...
            playListURI = generatePlaylist(spotifyToken, recommendedSongTrackList)

        #Start playing playlist
        deviceID = spotifyToken.playback_devices()
        spotifyToken.playback_start_context(playListURI, deviceID)
